...
function ProfileEditor:CreateSettingsSection(parent)
    ...
    enableCheck:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("When enabled, detects other Hope is Here users nearby", 1, 1, 1, true)
    ...
    shareCheck:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("appearance) with other Hope is Here users.", 1, 1, 1, true)
        GameTooltip:Show()
    end)
